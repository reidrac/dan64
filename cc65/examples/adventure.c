 ...
 *
 * 0.9-dan  15 Mar 2015  Work in 32 x 24 screen, DAN64 support
 *
 */
...
const char *introText = " ABANDONED FARMHOUSE ADVENTURE\n       BY JEFF TRANTER\n\nYOUR THREE-YEAR-OLD GRANDSON HAS GONE MISSING AND WAS LAST SEEN HEADED IN THE DIRECTION OF THE\nABANDONED FAMILY FARM.\nIT'S A DANGEROUS PLACE TO PLAY. YOU HAVE TO FIND HIM BEFORE HE\nGETS HURT, AND IT WILL BE\nGETTING DARK SOON...\n\n";
