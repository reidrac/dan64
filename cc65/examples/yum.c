 ...
 *
 * 0.1-dan  15 Mar 2015  Adapted to DAN64 with minimal aesthetic changes.
 *
 */
...
char *computerNames[MAXPLAYERS] = { "DAN", "ATMEL", "MEGA" };
...
char help_text0[] =
	   "THIS IS A COMPUTER VERSION OF\n"
	   "THE GAME YUM, SIMILAR TO GAMES\n"
	   "KNOWN AS YAHTZEE, YACHT AND\n"
	   "GENERALA. EACH PLAYER ROLLS\n"
	   "FIVE DICE UP TO THREE TIMES\n"
	   "AND THEN APPLIES THE DICE\n"
	   "TOWARD A CATEGORY TO CLAIM\n"
	   "POINTS.   THE GAME HAS 12\n"
	   "ROUNDS DURING WHICH EACH\n"
	   "PLAYER ATTEMPTS TO CLAIM THE\n"
	   "MOST POINTS IN EACH CATEGORY.\n\n"
	   "THE WINNER IS THE PERSON SCOR-\n"
	   "ING THE MOST POINTS AT THE\n"
	   "END OF THE GAME.\n\n"
	   "THIS VERSION SUPPORTS UP TO\n"
	   "THREE PLAYERS OF WHICH ANY CAN\n"
	   "BE HUMAN OR COMPUTER PLAYERS.\n";
...
char help_text1[] =
	   ...
	   "YUM (30)\n  5 DICE THE SAME\n\n"
	   "BONUS OF 25 POINTS IF UPPER\nSECTION"
	   " IS 63 OR MORE.\n";

/* Display help information. Needs to fit on 32 cols by 24 lines screen. */
void displayHelp()
{
	printf(help_text0);
	pressEnter(0);
...
int humanPickCategory()
{
    ...
    while (true) {
        snprintf(buffer, sizeof(buffer), "\n%s, WHAT CATEGORY DO YOU\nWANT TO CLAIM? ", playerName[player]);
